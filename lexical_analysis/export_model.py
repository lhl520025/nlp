...
parser.add_argument("--params_path", type=str, default='./output/best_model.pdparams', help="The path of model parameter to be loaded.")
...
def main():
    ...
    model = paddle.jit.to_static(
        model,
        input_spec=[
            InputSpec(shape=[None, None], dtype="int64", name='token_ids'), InputSpec(shape=[None], dtype="int64", name='length')
        ])
