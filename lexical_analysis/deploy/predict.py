...
# yapf: disableE:\npl_workspace\PaddleNLP\examples\lexical_analysis\infer_model
...
def get_result():
    ...
    #         infer_ds += [line.strip()]
    infer_ds= ["领导您好！我是贵州省黄平县重安镇包老村村民，当地村民于2021年1月24日凌晨发现有人非法采矿，24日全天24小时村民轮班守住挖掘机，严重破坏本地村民的自然环境。地方派出所不予解决，政府部门回应模棱两可。请求上级政府予以解决为谢"]
